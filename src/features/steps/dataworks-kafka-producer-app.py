...
def step_impl(context):
    ...
    aws_helper.execute_linux_command(context.dataworks_kafka_producer_instance, linux_command)
...
def step_impl(context, file_name):
    ...
    data_key, hsm_pub_key, encrypted_data_key = dataworks_kafka_producer_helper.create_new_data_key()

    # Encrypt the data
    encrypted_data, iv, encryption_data_key_id = dataworks_kafka_producer_helper.encrypt_data_aes_ctr(
    ...
    aws_helper.upload_file_to_s3(body=encrypted_data,
...
def step_impl(context, expected_lag):
    ...
    response = aws_helper.execute_linux_command(context.dataworks_kafka_producer_instance, linux_command)
